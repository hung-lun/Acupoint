...
var count1 = (getUrlString.match(/01/g) || []).length;  //取得01有幾個 - 肝腎陰虛型
console.log(count1);

var count2 = (getUrlString.match(/02/g) || []).length;  //取得02有幾個 - 肺陰不足型
console.log(count2);

var count3 = (getUrlString.match(/03/g) || []).length;  //取得03有幾個 - 脾胃溼熱型
console.log(count3);

var count4 = (getUrlString.match(/04/g) || []).length;  //取得04有幾個 - 脾肺伏熱型
console.log(count4);

var count5 = (getUrlString.match(/05/g) || []).length;  //取得05有幾個 - 肝氣鬱結型
console.log(count5);

var count6 = (getUrlString.match(/06/g) || []).length;  //取得06有幾個 - 脾肺虛寒型
console.log(count6);
...
if((count1 > count2) & (count1 > count3) & (count1 > count4) & (count1 > count5) & (count1 > count6)){
    ...
    function m01011(){
        document.getElementById("medicine").src = "../medicine/01-01.html";
    }

    var m0102 = document.getElementById("m0102");  //滋腎明目湯
    m0102.addEventListener("click", m01022);
    function m01022(){
        document.getElementById("medicine").src = "../medicine/01-02.html";
    }
    ...
    function m02011(){
        document.getElementById("medicine").src = "../medicine/02-01.html";
    }

    var m0202 = document.getElementById("m0202");  //百合固金湯
    m0202.addEventListener("click", m02022);
    function m02022(){
        document.getElementById("medicine").src = "../medicine/02-02.html";
    }
    ...
    function m03011(){
        document.getElementById("medicine").src = "../medicine/03-01.html";
    }
    ...
    function m04011(){
        document.getElementById("medicine").src = "../medicine/04-01.html";
    }

    var m0402 = document.getElementById("m0402");  //銀翹散
    m0402.addEventListener("click", m04022);
    function m04022(){
        document.getElementById("medicine").src = "../medicine/04-02.html";
    }
    ...
    function m05011(){
        document.getElementById("medicine").src = "../medicine/05-01.html";
    }

    var m0502 = document.getElementById("m0502");  //柴胡疏肝散
    m0502.addEventListener("click", m05022);
    function m05022(){
        document.getElementById("medicine").src = "../medicine/05-02.html";
    }
    ...
    function m06011(){
        document.getElementById("medicine").src = "../medicine/06-01.html";
    }
